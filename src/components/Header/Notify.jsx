  ...
  return (
    <div className="relative flex flex-col gap-2">
      <div
        ...
        className="hover:opacity-80 flex-shrink-0 cursor-pointer transition-all duration-300"
      >
        <svg
          width="24"
          height="26"
...
function NotifyItem({ item }) {
  return (
    <div className="flex items-center gap-1.5 w-full px-2.5 py-1 rounded-lg hover:bg-accent-400 transition-all duration-300">
...
<rect width="9.64513" height="9.64513" fill="white" transform="translate(0.220703 0.207855)"/>
      ...
      <div className="flex flex-col gap-0.5 w-full">
        ...
        <p className="text-gray-100 text-sm font-normal">Отправил вам предложение обмена</p>
      </div>
    </div>
  );
}
