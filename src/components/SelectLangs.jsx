...
export default function SelectLangs({ onLanguageChange }) {
  ...
  return (
    <div className="flex flex-col flex-shrink-0 gap-1 relative">
      <div
        className="bg-accent-200  w-full rounded-lg py-2.5 px-4 gap-1 flex items-center justify-center cursor-pointer"
        onClick={toggleDropdown}
      >
        <img
          src={`/assets/images/flags/${activeLang.code}.png`}
          alt={activeLang.name}
      ...
      <div
        className={`dropdown-menu absolute top-12 left-0 w-full bg-accent-200 rounded-lg py-2.5 px-1 gap-1 flex flex-col z-10 transition-all duration-300 ease-in-out ${
