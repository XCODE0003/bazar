...
export default function UsersPage() {
  ...
  return (
    ...
    <div className="admin_main_dash admin_main_users">
      <div className="admin_main_deal">
        <div className="admin_main_deal_content">
          <h1 className="admin_main_deal_tittle">Пользователи</h1>

          <div className="admin_main_deal_up">
            <div className="admin_main_deal_up_sort_items">
              <p className="admin_main_deal_up_sort_item">Пользователи</p>
              <p className="admin_main_deal_up_sort_item">Администраторы</p>
            </div>
          ...
          <div className="admin_main_deal_tabble">
            <table className="admin_main_deal_tabble_main">
              <thead>
                <tr>
                  <td>
                    <p className="admin_main_deal_tabble_main_tittle">Ник </p>{" "}
                  </td>
                  <td>
                  ...
                  <td>
                    <p className="admin_main_deal_tabble_main_tittle">Роль </p>
                  </td>
                  <td>
                    {" "}
                    <p className="admin_main_deal_tabble_main_tittle">
              ...
              <tbody>
                <tr className="admin_main_deal_tabble_main_line">
                  <td className="admin_main_deal_tabble_main_text">
                    <img src="./assets/img/admin_deal_icon.svg" alt="" />
                    User1
                  </td>
                  <td className="admin_main_deal_tabble_main_text">
                    1 Апреля 2024
                  ...
                  <td>
                    <div className="admin_main_deal_tabble_main_text_status admin_main_deal_tabble_main_text_status_end">
                      Администратор
                    </div>
                  </td>
                  <td>
                    <p
                      ...
                      className="admin_main_deal_tabble_main_lin openSettingUser"
                    >
                      Настроить
                    </p>
                  </td>
